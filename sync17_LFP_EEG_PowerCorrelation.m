...
clc
close all
time= load ('time_steps_epoch.mat');
load sampleEEGdata.mat;
load FreezingTurnP1_EEG_48.mat;
load time_steps_epoch.mat;
EEG2 = pop_loadset('PD09_filtered.set');
EEG.data = FreezingTurnP1Data;
EEG.chanlocs= EEG2.chanlocs;
EEG.times= time.time_steps;
EEG.srate = EEG2.srate;
EEG.trials= size(FreezingTurnP1Data,3);
EEG.pnts= size(FreezingTurnP1Data,2);
clear EEG2;
%%
