...
for ti=1:5:n_data
    ...
    set(filterplotH1,'XData',time_steps(1:ti),'YData',real_data(1,1:ti))
    set(filterplotH2,'XData',time_steps(1:ti),'YData',real_data(2,1:ti))
    
    % update cartesian plot of phase angles
    set(phaseanglesH1,'XData',time_steps(1:ti),'YData',phase_data(1,1:ti))
    set(phaseanglesH2,'XData',time_steps(1:ti),'YData',phase_data(2,1:ti))
